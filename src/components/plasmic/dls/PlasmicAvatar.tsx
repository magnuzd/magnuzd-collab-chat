...
import matheusFerreroKmuTlgruLrUUnsplashjpgGvgtZuwe1 from "./images/matheusFerreroKmuTlgruLrUUnsplashjpg.jpeg"; // plasmic-import: GVGTZuwe1/picture
          ...
          ? p.renderPlasmicSlot({
              defaultContents: true ? (
                <p.PlasmicImg
                  ...
                  src={{
                    src: matheusFerreroKmuTlgruLrUUnsplashjpgGvgtZuwe1,
                    fullWidth: 640,
                    fullHeight: 427,
        ...
        {(
          ...
          ? p.renderPlasmicSlot({
              ...
              className: classNames(sty.slotTargetInitials, {
                ...
                [sty.slotTargetInitialssize_large_text]:
                  hasVariant(variants, "text", "text") &&
                  hasVariant(variants, "size", "large"),
                [sty.slotTargetInitialssize_xs_text]:
                  hasVariant(variants, "text", "text") &&
