...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: QtgH6B6JlnAfz/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const [
    isDraftNewMessageFocusVisibleWithin,
    triggerDraftNewMessageFocusVisibleWithinProps
  ] = useTrigger("useFocusVisibleWithin", {
    isTextInput: true
  });

  const triggers = {
    focusVisibleWithin_draftNewMessage: isDraftNewMessageFocusVisibleWithin
  };

  return (
    <div
      data-plasmic-name={"draftNewMessage"}
      data-plasmic-override={overrides.draftNewMessage}
      ...
      className={classNames(
        ...
        sty.draftNewMessage,
        {
          [sty.draftNewMessage___focusVisibleWithin]:
            triggers.focusVisibleWithin_draftNewMessage,
          [sty.draftNewMessagecolor_dark]: hasVariant(
            variants,
            "color",
            "dark"
          ),
          [sty.draftNewMessageisDisabled]: hasVariant(
            variants,
            "isDisabled",
            "isDisabled"
          ),
          [sty.draftNewMessageshowStartIcon]: hasVariant(
            variants,
            "showStartIcon",
            "showStartIcon"
          )
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__zTz0E)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__d8QNp)}
                role={"img"}
              />
            ),
...
export const PlasmicTextInput = Object.assign(
  ...
  makeNodeComponent("draftNewMessage"),
  {
